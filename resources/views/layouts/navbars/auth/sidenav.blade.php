    ...
    <div class="sidenav-content">
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                <a class="nav-link {{  str_contains(request()->url(), 'evaluasi') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'evaluasi']) }}">
                    <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ str_contains(request()->url(), 'periode') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'periode']) }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ str_contains(request()->url(), 'admin') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'admin']) }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
