                                ...
                                <form id="logbookForm" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control ps-0 border-start-0" id="tanggal" name="tanggal" required max="{{ date('Y-m-d') }}">
                                        </div>
                                        <div class="invalid-feedback">Tanggal aktivitas tidak boleh kosong dan tidak boleh di masa depan</div>
                                    </div>
                                    
                                    <div class="mb-4">
                                        <label for="deskripsi" class="form-label">Deskripsi Kegiatan</label>
                                        <div class="input-group">
                                            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4" placeholder="Jelaskan aktivitas yang Anda lakukan hari ini" required minlength="10"></textarea>
                                        </div>
                                        <div class="invalid-feedback">Deskripsi kegiatan tidak boleh kosong dan minimal 10 karakter</div>
                                        <div class="form-text text-end"><span id="charCount">0</span>/500 karakter</div>
                                    </div>
                                    
                                    <div class="mb-4">
                                        <label for="foto" class="form-label">Foto Aktivitas <span class="text-muted">(Opsional)</span></label>
                                        <div class="upload-container">
                                            <input type="file" class="file-input" id="foto" name="foto" accept="image/*" onchange="previewImage(this)">
                                    ...
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-primary py-2" id="simpanAktivitas">
                                            <span id="btnText"><i class="bi bi-journal-check me-2"></i>Simpan Aktivitas</span>
                                        ...
                                        <div class="skeleton-timeline-entries">
                                            <div class="skeleton-timeline-item mb-3">
                                                ...
                                                <div class="skeleton-timeline-content">
                                                    <div class="skeleton-text skeleton-text-sm mb-2" style="width: 140px;"></div>
                                                    <div class="skeleton-text skeleton-text-xs mb-1" style="width: 100%;"></div>
                                                    <div class="skeleton-text skeleton-text-xs mb-1" style="width: 80%;"></div>
                                                    <div class="skeleton-text skeleton-text-xs mb-2" style="width: 60%;"></div>
                                            ...
                                            <div class="skeleton-timeline-item mb-3">
                                                ...
                                                <div class="skeleton-timeline-content">
                                                    <div class="skeleton-text skeleton-text-sm mb-2" style="width: 160px;"></div>
                                                    <div class="skeleton-text skeleton-text-xs mb-1" style="width: 100%;"></div>
                                                    <div class="skeleton-text skeleton-text-xs mb-1" style="width: 90%;"></div>
                                                    <div class="skeleton-text skeleton-text-xs mb-2" style="width: 70%;"></div>
                                                    <div class="skeleton-button-sm"></div>
                                                </div>
                                            </div>
                                            <div class="skeleton-timeline-item mb-3">
                                                <div class="skeleton-timeline-dot"></div>
                                                <div class="skeleton-timeline-content">
                                                    <div class="skeleton-text skeleton-text-sm mb-2" style="width: 130px;"></div>
                                                    <div class="skeleton-text skeleton-text-xs mb-1" style="width: 100%;"></div>
                                                    <div class="skeleton-text skeleton-text-xs mb-1" style="width: 85%;"></div>
                                                    <div class="skeleton-button-sm"></div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card-header bg-white pt-4 pb-3 border-0">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="search-container">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="searchActivities" placeholder="Cari aktivitas...">
                                ...
                                <div id="timelineContainer" class="timeline-container">
                                    ...
                                    <div id="timelinePlaceholder" class="p-4 text-center d-none">
                                        <div class="empty-state">
                                            ...
                                            <p class="text-muted">Mulai catat aktivitas magang harian Anda dengan mengisi form di samping</p>
                                        </div>
                                    </div>
